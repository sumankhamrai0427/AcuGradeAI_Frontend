...
import { ParentAccount, ChildAccount, ExamSubmission } from '../types';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 bg-white rounded-3xl border border-stone-200/80 shadow-sm p-6 sm:p-7 space-y-6">
          <div className="flex items-center justify-between pb-4 border-b border-stone-100">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h2 className="text-base font-bold text-stone-900">Create New Schedule</h2>
                <p className="text-xs text-stone-500">Configure parameters & send assignment</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleScheduleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full px-3.5 py-2.5 rounded-xl border border-stone-200 bg-stone-50/50 text-xs font-semibold text-stone-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-400/50 focus:border-yellow-400 transition-all"
              >
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl border border-stone-200 bg-stone-50/50 text-xs font-medium text-stone-800 placeholder:text-stone-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-400/50 focus:border-yellow-400 transition-all"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-2.5 sm:px-3 py-2.5 rounded-xl border border-stone-200 bg-stone-50/50 text-xs font-semibold text-stone-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-400/50 focus:border-yellow-400 transition-all truncate"
                >
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-2 sm:px-3 py-2 rounded-xl border border-stone-200 bg-stone-50/50 text-xs font-medium text-stone-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-400/50 focus:border-yellow-400 transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-stone-700">Note for Child (Optional)</label>
              <textarea
                rows={2}
                ...
                className="w-full px-3.5 py-2 rounded-xl border border-stone-200 bg-stone-50/50 text-xs font-medium text-stone-800 placeholder:text-stone-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-400/50 focus:border-yellow-400 transition-all resize-none"
              />
            </div>
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl border border-stone-200/80 shadow-sm p-6 sm:p-7 space-y-6">
          ...
          {isLoadingList ? (
            ...
            <div className="py-16 text-center space-y-3 bg-stone-50/60 rounded-2xl border border-dashed border-stone-200">
            ...
            <div className="space-y-3.5 max-h-[640px] overflow-y-auto custom-scrollbar pr-1">
              {filteredExams.map((exam) => {
                ...
                return (
                  <div
                    key={exam.id}
                    className={`p-4 sm:p-5 rounded-2xl border transition-all duration-200 flex flex-col gap-3 relative ${
                      isCompleted 
