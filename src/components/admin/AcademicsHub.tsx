...
export const AcademicsHub: React.FC = () => {
  ...
  }, [activeTab, page, limit, filterDifficulty, filterType, filterBoard, filterClass]);
          ...
          <div className="bg-white p-5 rounded-3xl border border-stone-200/80 shadow-xs flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                placeholder="Search question text, explanation, or topic..."
                className="w-full pl-10 pr-4 py-2.5 bg-stone-50 border border-stone-200/80 rounded-2xl text-xs font-medium focus:outline-none focus:ring-2 focus:ring-yellow-400"
              />
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
              <select
                ...
                className="px-3 py-2 bg-stone-50 border border-stone-200/80 rounded-xl text-xs font-semibold text-stone-700 focus:outline-none"
              >
