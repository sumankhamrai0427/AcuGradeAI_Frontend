    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="text-center max-w-3xl mx-auto mb-10">
        ...
        <div className="flex items-center justify-center gap-3 mt-6">
          <span className={`text-xs sm:text-sm font-semibold ${billingCycle === 'monthly' ? 'text-stone-900' : 'text-stone-400'}`}>
            Monthly Billing
          </span>
          <button
            id="billing-cycle-toggle-btn"
            onClick={() => setBillingCycle(billingCycle === 'monthly' ? 'yearly' : 'monthly')}
            className="w-14 h-7 bg-stone-900 rounded-full p-1 transition-colors flex items-center"
          >
            <div
              className={`w-5 h-5 rounded-full bg-white transition-transform ${
                billingCycle === 'yearly' ? 'transform transtone-x-7 bg-yellow-400' : ''
              }`}
            />
          </button>
          <span className={`text-xs sm:text-sm font-semibold flex items-center gap-1.5 ${billingCycle === 'yearly' ? 'text-stone-900' : 'text-stone-400'}`}>
      ...
      {selectedPlanSuccess && (
        <div className="max-w-md mx-auto mb-8 p-4 rounded-2xl bg-yellow-50 border border-yellow-300 text-yellow-900 text-xs font-semibold flex items-center gap-2 animate-in fade-in zoom-in-95">
          ...
          return (
            <div
              ...
              className={`bg-white rounded-3xl border transition-all p-8 flex flex-col justify-between relative ${
                plan.isPopular
                  ? 'border-yellow-400 ring-2 ring-yellow-200 shadow-xl lg:-translate-y-2'
                  : 'border-stone-200 shadow-sm hover:border-stone-300'
              }`}
            >
              {plan.badge && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full text-[11px] font-bold bg-yellow-400 text-stone-900 shadow-sm whitespace-nowrap">
                  {plan.badge}
                </div>
              )}
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  {isCurrent && (
                    <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-yellow-100 text-yellow-800">
                      Active Plan
                    </span>
                  )}
                </div>
                ...
                <div className="flex items-baseline gap-1 mb-6 pb-6 border-b border-stone-100">
                  ...
                  {plan.priceMonthly === 0 && (
                    <span className="text-xs text-stone-400 font-normal ml-2">Always 100% Free</span>
                  )}
                </div>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  {plan.features.map((feat, idx) => (
                    <div key={idx} className="flex items-start gap-2.5 text-xs text-stone-700 leading-snug">
                      <div className="w-4 h-4 rounded-full bg-yellow-50 text-yellow-600 flex items-center justify-center shrink-0 mt-0.5 font-bold text-[10px]">
                        ✓
                      </div>
                      <span>{feat}</span>
                    </div>
                ...
                <button
                  ...
                  className={`w-full py-3.5 px-4 rounded-2xl text-xs sm:text-sm font-bold transition-all shadow-xs ${
                    isCurrent
                      ...
                      : plan.isPopular
                      ? 'bg-yellow-400 hover:bg-yellow-500 text-stone-900 shadow-yellow-200'
          ...
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="border-b border-stone-200 text-stone-500 font-bold uppercase tracking-wider">
                ...
                <th className="pb-3 px-4 text-center text-yellow-700">Scholar Pro</th>
                <th className="pb-3 pl-4 text-center text-stone-900">Genius Competitive</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-stone-200 text-stone-700">
              <tr>
                ...
                <td className="py-3 pl-4 text-center font-bold text-yellow-700">Unlimited</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="py-3 px-4 text-center text-stone-400">Basic Answer Key</td>
                <td className="py-3 px-4 text-center font-bold text-yellow-700">✓ Step-by-Step AI</td>
                <td className="py-3 pl-4 text-center font-bold text-yellow-700">✓ Priority Gemini 3.7</td>
              </tr>
              <tr>
                <td className="py-3 pr-4 font-semibold">Evolutionary K-Graph Mastery Tracker</td>
                <td className="py-3 px-4 text-center text-stone-400">Limited</td>
                <td className="py-3 px-4 text-center font-bold text-yellow-700">✓ Full Topic Radar</td>
                <td className="py-3 pl-4 text-center font-bold text-yellow-700">✓ Full Topic Radar</td>
              </tr>
              <tr>
                ...
                <td className="py-3 px-4 text-center text-stone-400">—</td>
                <td className="py-3 pl-4 text-center font-bold text-yellow-700">✓ Included</td>
              </tr>
            </tbody>
          </table>
        </div>
